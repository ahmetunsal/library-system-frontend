...
export default function AddUserModal({ open, setOpen, deneme, setDeneme }) {
    const { newUserObj, postRegisterUser, USER_ROLES } = useContext(context);
    ...
    useEffect(() => {
        console.log("new_user_degisti", newUser);
    }, [newUser]);
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-2">
                    {
                        Object.keys(newUserObj).map(u => {
                            ...
                            if(u == "password") element = <input type='text' disabled className='border text-black' defaultValue={newUserObj[u]} />
