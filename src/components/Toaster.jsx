...
const Toaster = () => {
    ...
    const { isShowAlert, setIsShowAlert, alertMessage, alertType } = useContext(context)
  ...
  return (
    <div className={`${isShowAlert ? "flex" : "hidden"} w-full md:w-1/4 md:pe-3 flex items-center justify-center absolute top-3 right-0 z-50`}>
      <div
        id="toast-alert"
